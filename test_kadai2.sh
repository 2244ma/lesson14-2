...
./kadai2.sh 100 > $tmp-err && ERROR_EXIT "we can't script"
...
./kadai2.sh 0 10 > $tmp-err && ERROR_EXIT "we can't script"
...
./kadai2.sh 100 200 3 > $tmp-err && ERROR_EXIT "we can't script"
...
./kadai2.sh 1 2 30 40 > $tmp-err && ERROR_EXIT "we can't script"
